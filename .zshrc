...
export GITHUB_USER="cosmicbuffalo"
...
seek_relative_end() {
    ...
    seek_time=$(echo "$duration - $relative_time" | bc)
    ffmpeg -ss "$seek_time" -i "$input_file" -c copy "output_$relative_time.mp4"
}
# Example usage: seek_relative_end input.mp4 1
