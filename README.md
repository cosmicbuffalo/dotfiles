...
This is a fresh fork of Dries Vints' Dotfiles. I'm currently in the process of cleaning up my own dotfiles to move into here. Still a WIP
...
2. [Generate a new public and private SSH key](https://docs.github.com/en/github/authenticating-to-github/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent) by running:
   ...
   ```zsh
   curl https://raw.githubusercontent.com/cosmicbuffalo/dotfiles/HEAD/ssh.sh | sh -s "<your-email-address>"
   ```

3. Clone this repo to `~/.dotfiles` with:

    ```zsh
    git clone --recursive git@github.com:cosmicbuffalo/dotfiles.git ~/.dotfiles
    ```
